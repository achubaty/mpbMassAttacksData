...
df_params <- SpaDES.core::moduleParams("mpbMassAttacksData", "..")
...
df_inputs <- SpaDES.core::moduleInputs("mpbMassAttacksData", "..")
...
df_outputs <- SpaDES.core::moduleOutputs("mpbMassAttacksData", "..")
